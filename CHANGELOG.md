...
- **Added dependencies**.
    ...
    - Dev Dependencies
        ...
        - `@typescript-eslint/eslint-plugin` - `8.58.1` - needed for TypeScript linting.
          `@typescript-eslint/parser` - `8.58.1` - needed for TypeScript linting.
        - `bun-types` - `1.3.12` - needed for testing purposes only.
        - `glob` - `13.0.6` - needed for packages utilities.
        - `portless` - `0.10.1` - needed for local development. Replace port numbers with stable names.
...
- **Update dependencies** — address potential vulnerabilities and/or improvements in development dependencies.
    ...
    - Dev Dependencies
        ...
        - `typescript-eslint` from `8.33.1` to `8.58.1`
