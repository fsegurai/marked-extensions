...
Thanks for your interest in improving the **marked-extensions** project! Whether it's fixing bugs, improving documentation, or suggesting new features—your help is welcome 🙏
...
bun run generate:bundle  # adds your extension to the @fsegurai/marked-extensions-bundle re-exports
bun run generate:readme  # regenerates every package's README.md, including the extensions table
